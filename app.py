...
def apply_chart_style(fig, title=None):
    """Estilo uniforme, ejecutivo y legible para todas las gráficas Plotly."""
    fig.update_layout(
        title=dict(text=title, font=dict(size=18, color="#0B2E4F")) if title else None,
        ...
        margin=dict(l=70, r=35, t=55 if title else 30, b=65),
...
st.markdown(
    ...
    <style>
      ...
      /* KPIs ejecutivos: importes completos y legibles */
      ...
      div[data-testid="stMetric"] [data-testid="stMetricLabel"] p {
          ...
          opacity:1 !important;
          -webkit-text-fill-color:#41546A !important;
      ...
      /* Sidebar: filtros claros, didácticos y de alto contraste */
...
with gauge_col:
    ...
    fig_comp = apply_chart_style(fig_comp)
...
with c1:
    ...
    fig_fc = apply_chart_style(fig_fc)
...
with c3:
    ...
    fig_iva = apply_chart_style(fig_iva)
...
with c4:
    ...
    fig_status = apply_chart_style(fig_status)
